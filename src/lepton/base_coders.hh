...
class BaseDecoder {
 public:
    ...
    virtual void reset_all_comm_buffers() = 0;  // free buffers & clear buffer queues (should be called only at "sync points" when all buffer contents was definitely consumed)
};
